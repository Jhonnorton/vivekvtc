 ...
 */
class ResellerRoles extends \Base\Entity\ResellerRoles implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'roleName', 'created', 'updated', 'serviceManager');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ResellerRoles $proxy) {
