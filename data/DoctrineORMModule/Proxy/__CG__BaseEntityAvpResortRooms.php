 ...
 */
class ResortRooms extends \Base\Entity\Avp\ResortRooms implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'description', 'resortId', 'price', 'image', 'metaTitle', 'lastUpdated', 'inStock', 'isDeleted');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ResortRooms $proxy) {
