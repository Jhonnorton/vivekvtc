 ...
 */
class InventoryItem extends \Base\Entity\Avp\InventoryItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'linkedTo', 'numberAvailable', 'netPrice', 'grossPrice', 'resortId', 'eventId', 'cruiseId', 'eventCategoryId', 'supplierName', 'email', 'phone', 'notes');
        }
