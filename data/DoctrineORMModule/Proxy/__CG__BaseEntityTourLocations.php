 ...
 */
class TourLocations extends \Base\Entity\TourLocations implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'tourId', 'countryId', 'city', 'fromDate', 'toDate', 'status', 'isDeleted', 'created', 'modified', 'serviceManager');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TourLocations $proxy) {
    ...
    public function setTourId($tourId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTourId', array($tourId));

        return parent::setTourId($tourId);
    }
    ...
    public function getTourId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTourId', array());
