 ...
 */
class InventoryExcursion extends \Base\Entity\InventoryExcursion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'resortId', 'hotelName', 'supplierName', 'numberAvailable', 'netPrice', 'grossPrice', 'excursionName', 'linkedTo', 'eventId', 'cruiseId', 'email', 'phone', 'notes', 'image');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InventoryExcursion $proxy) {
    ...
    public function setExcursionName($excursionName)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setExcursionName', array($excursionName));

        return parent::setExcursionName($excursionName);
    }
    ...
    public function getExcursionName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getExcursionName', array());

        return parent::getExcursionName();
    }
