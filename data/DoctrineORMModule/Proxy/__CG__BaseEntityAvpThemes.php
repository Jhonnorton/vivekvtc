 ...
 */
class Themes extends \Base\Entity\Avp\Themes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'image', 'status', 'isDeleted', 'type', 'userId', 'cost', 'createdDate', 'modifiedDate');
        }
