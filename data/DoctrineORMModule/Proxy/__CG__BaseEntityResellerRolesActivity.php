 ...
 */
class ResellerRolesActivity extends \Base\Entity\ResellerRolesActivity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'resellerRoleId', 'name', 'status', 'created', 'updated', 'serviceManager');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ResellerRolesActivity $proxy) {
