 ...
 */
class Tours extends \Base\Entity\Tours implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'startDate', 'endDate', 'minimumStayDays', 'isSignatured', 'categoryId', 'description', 'image', 'metaTitle', 'metaDescription', 'metaKeywords', 'itineraryPdf', 'countryId', 'status', 'isDeleted', 'created', 'modified', 'serviceManager');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tours $proxy) {
