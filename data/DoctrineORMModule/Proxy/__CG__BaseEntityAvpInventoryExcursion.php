 ...
 */
class InventoryExcursion extends \Base\Entity\Avp\InventoryExcursion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'resortId', 'hotelName', 'supplierName', 'numberAvailable', 'netPrice', 'grossPrice', 'excursionName', 'linkedTo', 'eventId', 'cruiseId', 'email', 'phone', 'notes');
        }
