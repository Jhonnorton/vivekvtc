 ...
 */
class EventItineraries extends \Base\Entity\Avp\EventItineraries implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'eventId', 'eventDate', 'lastUpdated');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventItineraries $proxy) {
