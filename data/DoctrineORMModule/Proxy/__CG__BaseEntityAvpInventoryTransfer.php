 ...
 */
class InventoryTransfer extends \Base\Entity\Avp\InventoryTransfer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'resortId', 'hotelName', 'supplierName', 'numberAvailable', 'dateTo', 'dateFrom', 'netPrice', 'grossPrice', 'transferName', 'linkedTo', 'eventId', 'cruiseId', 'email', 'phone', 'notes');
        }
