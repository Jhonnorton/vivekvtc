...
//            }
    ...
    var _getTotalTransfersCost = function() {
        ...
        $.each($('input[name="transfers[]"]:checked'), function() {
            transfersCost = transfersCost + parseFloat($(this).attr('grossPrice')) * noOfPerson;
...
//             _calcFinalCost();
    ...
    var _getAmountDues = function() {
        ...
        var balansAfterDeposit = parseFloat($('input[name="balansAfterDeposit"]').val());
       ...
       $('.cnt').each(function(){
        ...
        var divideDueAmt = balansAfterDeposit / i;
