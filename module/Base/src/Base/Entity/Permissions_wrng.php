 ...
 * Permissions
 *
 * @ORM\Table(name="permissions", indexes={@ORM\Index(name="FK_permissions_role_id", columns={"role_id"}), @ORM\Index(name="FK_permissions_resource_id", columns={"resource_id"}), @ORM\Index(name="FK_permissions_module_id", columns={"module_id"})})
 * @ORM\Entity
 */
