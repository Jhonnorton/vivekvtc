...
class CommunityUsers
{
     ...
     * @var string
     *
     * @ORM\Column(name="relationship_statuses", type="string", length=80, nullable=true)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="relation_with", type="integer", nullable=true)
     */
    ...
    /**
     * Set relationshipStatuses
     *
     * @param string $relationshipStatuses
     * @return CommunityUsers
     */
     ...
     * Set relationWith
     *
     * @param integer $relationWith
     * @return CommunityUsers
     */
    public function setRelationWith($relationWith)
    {
     ...
     * @return integer 
     */
    public function getRelationWith()
    {
