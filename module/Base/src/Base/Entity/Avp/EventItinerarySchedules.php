...
class EventItinerarySchedules
{
    ...
    private $id;
      ...
      /**
     * @var \Base\Entity\Avp\EventItineraries
     *
     * @ORM\ManyToOne(targetEntity="\Base\Entity\Avp\EventItineraries")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="event_itinerary_id", referencedColumnName="id")
     * })
     */
