...
class Imagine {
    ...
    public static $image;    
    //public static $srcDestination = '/home/vpadmin/rm.avp.image/img/user_uploads/'; // PRODUCTION!!!!!!!!
    //public static $imagesBaseUrl = 'http://img.vacationparties.com/img/user_uploads/'; //PRODUCTION
    ...
    public static $srcDestination = '/var/www/vhosts/mytravelcenter.net/httpdocs/imgs/user_uploads/'; // Live Travel center!!!!!!!
    public static $imagesBaseUrl = 'http://img.mytravelcenter.net/user_uploads/'; //Live Travel center
