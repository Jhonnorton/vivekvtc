...
//       $totalperson=$male+$female;
       ...
       if(!empty($collection)){
        ...
        $num++;
         ...
         if($male>$totalmales){
            $finalPrice=array('msg'=>'Sorry Males occupancy reached','price'=>'0','netprice'=>'0');
         }elseif($female>$totalfemales){
            $finalPrice=array('msg'=>'Sorry Females occupancy reached','price'=>'0','netprice'=>'0');
         }else{
            $finalPrice=array('msg'=>isset($msg)?$msg:'','price'=>$fnl_price,'netprice'=>$fnl_price_net);
         }
       }
       //echo "sdfasd";
       return $finalPrice;
