...
class AjaxController extends AbstractActionController {
    ...
    public function resortroomsAction() {
        ...
        $this->model = $this->getModel('LeadsAjaxModel');
        $collection = $this->model->getHotelRoom(array('resortId' => (int) $id));
    ...
    public function cruisecabinsAction() {
        $id = $this->params()->fromRoute('id', 0);
        $this->model = $this->getModel('LeadsAjaxModel');
        $collection = $this->model->getCruiseCabin(array('cruiseId' => (int) $id));
    ...
    public function eventroomsAction() {
        $id = $this->params()->fromRoute('id', 0);
        $this->model = $this->getModel('LeadsAjaxModel');
        $collection = $this->model->getEventRoom(array('eventId' => (int) $id));
        //d($collection);
