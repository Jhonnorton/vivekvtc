...
class AjaxModel extends \Base\Model\BaseModel {

    public function getReservation($id) {
        //  $collection = $this->getEntityManager()->getRepository('Reservation')->findAll();    
       //d($id);
     ...
     /*   $em = $this->getBaseEntityManager();
       ...
       */ 
       ...
       return PaymentsController::viewReservation($this->_serviceManager, $id);
