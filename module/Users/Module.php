	...
	public function checkAcl(MvcEvent $e) {
	    ...
	    if($loggedUser):
	        ...
	        //location to page or what ever
                echo "<script>alert('Sorry ! You are not allowed to access this Page.');
                        window.location = '/admin/dashboard';
                        </script>";
	        echo "Restricted  :  Sorry ! You are not allowed to access this Page.<br><br><a href='/admin/dashboard'>Click here to go back to Dashboard</a>";
                exit();
	    }
