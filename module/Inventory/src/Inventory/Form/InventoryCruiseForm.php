...
class InventoryCruiseForm extends Form implements ObjectManagerAwareInterface{
    ...
    public function __construct(ObjectManager $objectManager, ObjectManager $avpObjectManager, $targetEntity) {
        ...
        parent::__construct('inventory-cruise-cabins');
        ...
        $this->add(array(
                        ...
                        'options' => array(
                                        'label'          => 'Suite Name',
                                        'object_manager' => $this->getAvpObjectManager(),
                                        'target_class'   => 'Base\Entity\Avp\CruiseCabins',
                                        'property'       => 'deckName',
                                        'empty_option'   => 'please select suite...'
                        ),
                        'attributes' => array(
                                        'required' => 'required',
...
//                                        'label'          => 'Deck Number',
//                                        'empty_option'   => 'please select suite...',
//                                        'value_options'  => $this->_getDeckList(),
//                        ),
//                        'attributes' => array(
//                                        'required' => 'required',
//                        ),
//        ));
    ...
    protected function _getDeckList() {
