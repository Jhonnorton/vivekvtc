    ...
    public static function linkedTo(){     
        return array(        
            ...
            self::LINKED_TO_RESORT_NAME => array(                
                ...
                'collection' => self::$serviceManager ? self::getResortsCollection() : null,
                'linkedTo'=> array(                    
...
//            ),
            self::LINKED_TO_CRUISE_NAME => array(                
                ...
                'collection' => self::$serviceManager ? self::getCruisesCollection() : null,
                'linkedTo'=> array(                    
            ...
            self::LINKED_TO_EVENT_NAME => array(                
                ...
                'collection' => self::$serviceManager ? self::getEventsCollection() : null,
                'linkedTo'=> array(                    
...
//            ),
    ...
    public function getCollection($page = false,$source=null) {
    ...
    public static function getEventsCollection() {
        $collection = self::$serviceManager->get('Doctrine\ORM\EntityManager')->getRepository('\Base\Entity\Avp\Events')->findBy(array('isDeleted'=>0,'status'=>1,'approved'=>1));
        return $collection;
    }
    
    public static function getResortsCollection() {
        $collection = self::$serviceManager->get('Doctrine\ORM\EntityManager')->getRepository('\Base\Entity\Avp\Resorts')->findBy(array('isDeleted'=>0,'status'=>1));
        return $collection;
    }
    
    public static function getCruisesCollection() {
        $collection = self::$serviceManager->get('Doctrine\ORM\EntityManager')->getRepository('\Base\Entity\Avp\Cruises')->findBy(array('isDeleted'=>0,'status'=>1));
        return $collection;
    }
} 