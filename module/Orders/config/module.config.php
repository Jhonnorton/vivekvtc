...
return array(
    ...
    'router' => array(
	   ...
	   'orders-event-view' => array(
	      ...
	      'orders-event-edit' => array(
                'type' => 'Segment',
                'options' => array(
                    // Change this to something specific to your module
                    'route' => '/admin/reservation/event/edit/:id',
                    'defaults' => array(
                        // Change this value to reflect the namespace in which
                        // the controllers for your module are found
                        '__NAMESPACE__' => 'Orders\Controller',
            ...
            'orders-event-sendmail' => array(
                'type' => 'Segment',
                'options' => array(
                    // Change this to something specific to your module
                    'route' => '/admin/reservation/event/sendmail/:id',
                    'defaults' => array(
                        '__NAMESPACE__' => 'Orders\Controller',
                        'controller' => 'Event',
                        'action' => 'sendmail',
	   ...
	   'orders-resort-view' => array(
	    ...
	    'orders-resort-edit' => array(
                'type' => 'Segment',
                'options' => array(
                    // Change this to something specific to your module
                    'route' => '/admin/reservation/resort/edit/:id',
                    'defaults' => array(
                        // Change this value to reflect the namespace in which
                        // the controllers for your module are found
                        '__NAMESPACE__' => 'Orders\Controller',
            ...
            'orders-resort-sendmail' => array(
                'type' => 'Segment',
                'options' => array(
                    // Change this to something specific to your module
                    'route' => '/admin/reservation/resort/sendmail/:id',
                    'defaults' => array(
                        '__NAMESPACE__' => 'Orders\Controller',
                        'controller' => 'OrdersResort',
                        'action' => 'sendmail',
	   ...
	   'orders-resort-canceled' => array(
	     ...
	     'orders-cruise-view' => array(
               ...
               'orders-cruise-sendmail' => array(
                'type' => 'Segment',
                'options' => array(
                    // Change this to something specific to your module
                    'route' => '/admin/reservation/cruise/sendmail/:id',
                    'defaults' => array(
                        '__NAMESPACE__' => 'Orders\Controller',
                        'controller' => 'OrdersCruises',
                        'action' => 'sendmail',
	   ...
	   'orders-cancel' => array(
	    ...
	    'orders-cancel-view' => array(
             ...
             'orders-cancel-reinstate' => array(
                'type' => 'Segment',
                'options' => array(
                    // Change this to something specific to your module
                    'route' => '/admin/cancel/reinstate/:id',
                    'defaults' => array(
                        '__NAMESPACE__' => 'Orders\Controller',
                        'controller' => 'Orders',
                        'action' => 'reinstate',
	   ...
	   'orders-pending-view' => array(
                'type' => 'Segment',
                'options' => array(
                    // Change this to something specific to your module
                    'route' => '/admin/reservation/pending/view/:id',
                    'defaults' => array(
                        '__NAMESPACE__' => 'Orders\Controller',
                        'controller' => 'OrdersPending',
                        'action' => 'view',
            ...
            'orders-pending-delete' => array(
                'type' => 'Segment',
                'options' => array(
                    // Change this to something specific to your module
                    'route' => '/admin/reservation/pending/delete/:id',
                    'defaults' => array(
                        '__NAMESPACE__' => 'Orders\Controller',
                        'controller' => 'OrdersPending',
                        'action' => 'delete',
            ...
            'orders-pending-sendmail' => array(
                'type' => 'Segment',
                'options' => array(
                    // Change this to something specific to your module
                    'route' => '/admin/reservation/pending/sendmail/:id',
                    'defaults' => array(
                        '__NAMESPACE__' => 'Orders\Controller',
                        'controller' => 'OrdersPending',
                        'action' => 'sendmail',
            ...
            'orders-pending-markcomplete' => array(
                'type' => 'Segment',
                'options' => array(
                    // Change this to something specific to your module
                    'route' => '/admin/reservation/pending/markcomplete/:id',
                    'defaults' => array(
                        '__NAMESPACE__' => 'Orders\Controller',
                        'controller' => 'OrdersPending',
                        'action' => 'markComplete',
             ...
             'order-apply-payment' => array(
                'type' => 'Segment',
                'options' => array(
                    // Change this to something specific to your module
                    'route' => '/admin/reservation/applypayment/:id',
                    'defaults' => array(
                        // Change this value to reflect the namespace in which
                        // the controllers for your module are found
                        '__NAMESPACE__' => 'Orders\Controller',
            ...
            'order-express-payment-response' => array(
                'type' => 'Segment',
                'options' => array(
                    // Change this to something specific to your module
                    'route' => '/admin/reservation/express-payment-response',
                    'defaults' => array(
                        // Change this value to reflect the namespace in which
                        // the controllers for your module are found
                        '__NAMESPACE__' => 'Orders\Controller',
             ...
             'order-add-traveller' => array(
                'type' => 'Segment',
                'options' => array(
                    // Change this to something specific to your module
                    'route' => '/admin/orders/ajax/add-traveller/:c',
                    'defaults' => array(
                        // Change this value to reflect the namespace in which
                        // the controllers for your module are found
                        '__NAMESPACE__' => 'Orders\Controller',
             ...
             'order-add-payment' => array(
                'type' => 'Segment',
                'options' => array(
                    // Change this to something specific to your module
                    'route' => '/admin/orders/add-payment',
                    'defaults' => array(
                        // Change this value to reflect the namespace in which
                        // the controllers for your module are found
                        '__NAMESPACE__' => 'Orders\Controller',
            ...
            'order-add-dues' => array(
                'type' => 'Segment',
                'options' => array(
                    // Change this to something specific to your module
                    'route' => '/admin/orders/ajax/add-dues/:d',
                    'defaults' => array(
                        // Change this value to reflect the namespace in which
                        // the controllers for your module are found
                        '__NAMESPACE__' => 'Orders\Controller',
            ...
            'order-issue-refund' => array(
                'type' => 'Segment',
                'options' => array(
                    // Change this to something specific to your module
                    'route' => '/admin/orders/ajax/issue-refund/:d',
                    'defaults' => array(
                        // Change this value to reflect the namespace in which
                        // the controllers for your module are found
                        '__NAMESPACE__' => 'Orders\Controller',
            ...
            'order-edit-add-traveller' => array(
                'type' => 'Segment',
                'options' => array(
                    // Change this to something specific to your module
                    'route' => '/admin/orders/ajax/edit-add-traveller/:count',
                    'defaults' => array(
                        // Change this value to reflect the namespace in which
                        // the controllers for your module are found
                        '__NAMESPACE__' => 'Orders\Controller',
