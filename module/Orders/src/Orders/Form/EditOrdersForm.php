...
class EditOrdersForm extends Form implements ObjectManagerAwareInterface {
    ...
    public function __construct(ObjectManager $objectManager, ObjectManager $avpObjectManager, $targetEntity) {
        ...
        if ($this->getTargetEntity()->getType() == \Orders\Model\Orders::CRUISE_CABIN) {
        ...
        if ($this->getTargetEntity()->getType() == \Orders\Model\Orders::EVENT_ROOM) {
        ...
        if ($this->getTargetEntity()->getType() == \Orders\Model\Orders::RESORT_ROOM) {
