...
class SendmailController extends \Base\Controller\BaseController{
    ...
    public static function sendMailOnReservation($serviceManager, $to,  array $data, array $params = null, $subject = 'Reservation'){
     ...
     public static function sendMailOnLead($serviceManager, $to, $subject,$message,$cc){
        if($serviceManager){
            $model = $serviceManager->get('Email');   
           //d($message);
            return $model->sendMailOnLead($to,$subject,$message,$cc);        
        }   
        return false;
    }
    ...
    public static function sendReceiptToClient($serviceManager, $to, $subject,$message){
        if($serviceManager){
            $model = $serviceManager->get('Email');                
            return $model->sendReceiptToClient($to,$subject,$message);        
        }   
        return false;
    }
  ...
  //  d($data);
    ...
    public static function sendMailOnExclusiveTemplate($serviceManager,$to,$subject){
        if($serviceManager){
            $model = $serviceManager->get('Email');                
            return $model->sendMailOnExclusiveTemplate($to,$subject='Template For you');        
        }   
        return false;
    }
