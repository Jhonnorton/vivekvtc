...
class SendmailController extends \Base\Controller\BaseController{
    ...
    public static function sendMailOnQuote($serviceManager, $to,array $data=null, array $params = null, $subject = 'Reservation Quote'){
   //   d($data);
        if($serviceManager){
            $model = $serviceManager->get('Email');                
            return $model->sendMailOnQuote($to, $data, $params,$subject );        
        }   
        return false;
    }
