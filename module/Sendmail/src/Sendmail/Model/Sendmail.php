    ...
    public function sendMailOnReservation($to, array $data, $subject, array $params = null) {
        ...
        if ($data) {
            ...
            if ($data['reservation']->getAffiliateId() != ""):
                $viewModel->setTemplate("template/templates/reservation_reseller.phtml");
            endif;
...
//echo $html;
      ...
      //  die;
        ...
        $cc="reservations@vacationparties.com";
        return Plugin\SendMail::sendMail($from, $to, $subject, $html, $cc);
    ...
    public function sendMailOnLead($to, $subject, $message, $cc=NULL) {
        ...
        // d($cc);
        //     d($subject);
        //$viewModel->data = $data;//comment by anup
...
public function sendMailOnExclusiveTemplate($to, $subject) {
        
        $html = "Hello,<br><br> New Template Exclusively has been added for you. Please Sign in http://reseller.mytravelcenter.net to have experience of new theme.<br><br> Thanks and Regards.<br>";
        $from = SendMailHelper::FROM;
