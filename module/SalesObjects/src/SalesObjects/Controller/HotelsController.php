...
class HotelsController extends \Base\Controller\BaseController {
	...
	public function addAction() {		
		...
		$form = new \SalesObjects\Form\ResortsForm ( $this->getServiceLocator()->get('doctrine.entitymanager.orm_avp'), '\Base\Entity\Avp\Resorts' );
		if ($this->request->isPost ()) {
			...
			if ($form->isValid ()) {
					...
					$this->addPageMessage('The resort has been saved.','success');				
	...
	public function editAction() {                
		...
		$form = new \SalesObjects\Form\ResortsForm ( $this->getServiceLocator()->get('doctrine.entitymanager.orm_avp'), $this->_entity, $this->_entity->getId ());
