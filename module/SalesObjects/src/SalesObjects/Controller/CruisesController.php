...
class CruisesController extends \Base\Controller\BaseController
{
        ...
        public function addAction() {
                ...
                $form = new \SalesObjects\Form\CruisesForm($this->getServiceLocator()->get('doctrine.entitymanager.orm_avp'), '\Base\Entity\Avp\Cruises' );																
                if ($this->request->isPost()) {
					...
					$this->model->save($object);			
                                        $this->addPageMessage('The cruise has been saved.','success');
        ...
        public function editAction() {
                ...
                $form = new \SalesObjects\Form\CruisesForm($this->getServiceLocator()->get('doctrine.entitymanager.orm_avp'), $this->_entity, $this->_entity->getId());		
                        ...
                        if ($form->isValid ()) {
                                if($this->model->isValidModelOnEdit($form)&&
                                   $this->model->isValidImage($form, $files)){	
                                        ...
                                        $this->addPageMessage('The cruise has been updated.','success');	
                                        $this->redirect()->toRoute('cruises');
                                }
                        } else {
                                $form->getMessages ();
